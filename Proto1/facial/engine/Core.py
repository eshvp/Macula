...
class DynamicFaceEvaluator:
    def __init__(self):
        ...
        self.tracker_type = "None"  # Add this line to track which tracker is being used
    ...
    def initialize_tracking(self, frame, face_rect):
        ...
        try:
            ...
            self.tracker_type = "CSRT"  # Add this line
            ...
            try:
                ...
                self.tracker_type = "CSRT"  # Add this line
                print("Using CSRT tracker (legacy API)")
            except AttributeError:
                try:
                    ...
                    for tracker_name in ['MOSSE', 'KCF', 'CSRT']:  # MOSSE is fastest
                        try:
                            ...
                            self.tracker_type = tracker_name  # Add this line
                            print(f"Using {tracker_name} tracker (legacy.Tracker API)")
                            break
                    ...
                    self.tracker_type = "Basic"  # Add this line
                    return True
    ...
    def evaluate_face_position(self, frame, initialize_if_needed=True):
        ...
        if self.tracking_enabled:
            ...
            # Add tracker type display
            cv2.putText(annotated, f"Tracker: {self.tracker_type}", (w - 150, 60),
                       cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 0), 2)
        else:
